    ...
    return (
        <div className='footer'>
            <div className='container'>
                <Grid col={4} mdCol={2} smCol={2} gap={50}>
                    <div className='footer__info'>
                        <div className='footer__info__title'>Tổng đài hỗ trợ</div>
                    ...
                    <div className='footer__info'>
                        <div className='footer__info__title'>Về DNS</div>
                        <div className='footer__info__content'>
                            {
                    ...
                    <div className='footer__info'>
                        <div className='footer__info__title'>Chăm sóc khách hàng</div>
                        <div className='footer__info__content'>
                            {
                    ...
                    <div className='footer__info'>
                        <p>
                            <Link to='/' className='footer__info__logo'>DNS</Link>
                        </p>
                        <ContactIcon 
                        ...
                        />
                        <div className='footer__info__paypal'>
                            <img 
